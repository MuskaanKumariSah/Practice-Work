...
class Chatbot:
    def __init__(self):
        self.rules = {
            ...
            'ask_date' : ['what is the date'],
            'ask_computer' : ['what is computer' ],
        ...
        self.responses = {
            ...
            'ask_date' : [date.today()],
             'ask_computer' : ['computer is an electronic device'],
            ...
            'default': ['How can I help you?','I didn\'t understand your query.Please rephrase your question.']
        }
